...
export default function Page() {
  ...
  return (
    <div className="primary  my-[2px] md:my-0 p-[2px] flex flex-col">
      ...
      <div className=" flex flex-row-reverse flex-wrap">
        <div className=" w-full flex flex-col">
          ...
          <section className="numberpad flex flex-col">
            ...
            <div className="pad-mode-container w-full flex py-[5px] mx-auto justify-center items-center">
              <button
                className={clsx(
        ...
        <div className=" w-full flex flex-col justify-between">
          ...
          <section className="controls mt-[10px] md:mt-0 flex flex-col justify-start items-center ">
            ...
            <div className="b1 relative w-full flex flex-col items-center gap-[2px]">
              <div className="w-full m-1 flex flex-wrap-reverse">
                <div className="b2 flex-1"></div>
                <FetchPuzzleButton
                ...
                <div className="b2 flex-1 grow-0"></div>
                <div className="b1 flex-1 flex justify-start">
                  <select
              ...
              />
              <div className="grid grid-cols-3 w-full p-[2px] min-w-0">
